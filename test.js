...
function Peer() {
	...
	this.connect = function(ip){
		this.connection.connect('tcp://127.0.0.1:12345')
		this.onConnect()
	}   
	this.onConnect = function(){
		this.connection.subscribe('AAPL');
  		this.connection.subscribe('GOOG');

  		console.log('connected!');

  		this.connection.on('message', function(data) {
    		console.log(Peer.connection.identity + ': received data ' + data.toString());
  		});
	}
}
